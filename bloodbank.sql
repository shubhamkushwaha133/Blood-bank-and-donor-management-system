...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2022 at 04:50 AM
...
(1, 'test', 'test@gmail.com', 'test', '8875643456', 'AB+', 'lucknow'),
...
(8, 'sk', 'shubham@gmail.com', '123456', '9631860196', 'AB+', 'bihar');
...
--
ALTER TABLE `blooddinfo`
  MODIFY `bdid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `blooddonate`
--
ALTER TABLE `blooddonate`
  MODIFY `donoid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `bloodinfo`
--
ALTER TABLE `bloodinfo`
  MODIFY `bid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `bloodrequest`
--
ALTER TABLE `bloodrequest`
  MODIFY `reqid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
